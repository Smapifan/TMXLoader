...
namespace TMXLoader
{
    ...
    public class PyNet
    {
        ...
        internal static void Multiplayer_ModMessageReceived(object sender, StardewModdingAPI.Events.ModMessageReceivedEventArgs e)
        {
            ...
            messages[e.Type].Add(new MPMessage(e.Type, Game1.GetPlayer(e.FromPlayerID, onlyOnline: true) ?? Game1.MasterPlayer, data, message.MessageType, Game1.player.UniqueMultiplayerID));
        }
